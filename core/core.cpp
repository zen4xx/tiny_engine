...
Tiny_engine::Tiny_engine(const char *applictaion_name, int width, int height, const char *title, uint8_t msaa_quality, uint8_t thread_count, bool is_debug, GLFWmonitor *monitor, GLFWwindow *window)
{
    glfwInit();
    ...
    m_renderer->setMsaaQuality(msaa_quality);
